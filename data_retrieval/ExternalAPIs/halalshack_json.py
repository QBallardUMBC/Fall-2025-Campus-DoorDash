...
load_dotenv()
restaurant_id = "5d5ad0294198d40d234ea0ff"
# Get Date
...
LOCATION_HALAL = os.getenv("LOCATION_HALALSHACK")
url = f"{API}/location/{LOCATION_HALAL}/periods"
