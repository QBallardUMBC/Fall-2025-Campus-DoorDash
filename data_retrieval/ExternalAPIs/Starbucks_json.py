...
load_dotenv()
restaurant_id = "587fc52c3191a23aa828ecc5"
...
LOCATION_STARBUCKS = os.getenv("LOCATION_STARBUCKS")
url = f"{API}/location/{LOCATION_STARBUCKS}/periods"
