...
load_dotenv()
restaurant_id = "61f9d7c8a9f13a15d7c1a25e"
...
LOCATION_TRUEGRITS = os.getenv("LOCATION_TRUEGRITS")
url = f"{API}/location/{LOCATION_TRUEGRITS}/periods"
