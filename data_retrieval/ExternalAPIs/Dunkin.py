...
load_dotenv()
restaurant_id = "5d5acf41c4b7ff0f10147f4a"
# Get date
...
print(dunkin_get_period())
print(dunkin_get_cate())
print(dunkin_get_food())
print(dunkin_get_nutrients())